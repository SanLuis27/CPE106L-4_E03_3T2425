...
class ChartsPage:
    ...
    def create_all_charts(self):
        ...
        deliveries = [5, 12, 20, 28]  # dummy delivery counts
...
class LoginApp:
    ...
    def open_dashboard(self, username, role="User"):
        ...
        tk.Button(dashboard, text="View Charts & Reports", command=lambda: ChartsPage(self.root, username, role),
                  bg="#7ed6df", fg="black").pack(pady=10)

        # Button to open Pickup Route Optimizer
        from route_ui import RoutePage
        tk.Button(dashboard, text="Pickup Route Optimizer", command=lambda: RoutePage(self.root),
